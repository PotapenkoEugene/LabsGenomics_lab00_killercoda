...
Then open: [click here]({{TRAFFIC_HOST1_8080}}) and click any file in the list — the `*_fastqc.html` reports (check Per base sequence quality) or `answers.txt` — to view or download it.
